// This file was adapted from CAF: github.com/actor-framework/actor-framework
...
int main(int argc, char** argv) {
  ...
  out << "// clang-format off\n"
      << "// DO NOT EDIT: "
         "this file is auto-generated by generate-enum-strings.\n"
  ...
  out << "bool from_string(caf::string_view in, " << enum_name << "& out) {\n  ";
  for (auto& val : enum_values)
